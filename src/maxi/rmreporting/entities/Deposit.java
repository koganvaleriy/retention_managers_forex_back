...
@Entity
@Table(name = DEPOSITS_NAME_TABLE)
public class Deposit {
	...
	public Deposit(double transactionID, double userID, RetManager retManager, double date, double amount, String account,
	...
	public String toString() {
		return "Deposit [transactionID=" + transactionID + ", UserID=" + userID + ", RetManager=" + retManager
